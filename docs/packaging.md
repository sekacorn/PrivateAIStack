...
```bash
python -m zipfile -l dist/privateaistack-0.1.0a1-py3-none-any.whl
tar -tf dist/privateaistack-0.1.0a1.tar.gz
```
...
.package-test-venv/Scripts/python -m pip install dist/privateaistack-0.1.0a1-py3-none-any.whl
